...
fn cli_can_prove_and_verify_stwo_decoding_history_segments_demo() {
    ...
    prove
        ...
        .stdout(predicate::str::contains("proof_backend: stwo"))
        .stdout(predicate::str::contains(
            "bundle_version: stwo-phase15-decoding-history-segment-bundle-v3",
        ))
    ...
    assert_eq!(
        proof_json
            .get("bundle_version")
            .and_then(serde_json::Value::as_str),
        Some("stwo-phase15-decoding-history-segment-bundle-v3")
    );
    assert_eq!(
        proof_json
            .get("total_segments")
    ...
    verify
        ...
        .stdout(predicate::str::contains("verified_stark: true"))
        .stdout(predicate::str::contains(
            "expected_bundle_version: stwo-phase15-decoding-history-segment-bundle-v3",
        ))
        .stdout(predicate::str::contains(
            "expected_proof_backend_version: stwo-phase12-decoding-family-v1",
        ))
...
fn cli_can_prove_and_verify_stwo_decoding_history_rollup_demo() {
    ...
    prove
        ...
        .stdout(predicate::str::contains("proof_backend: stwo"))
        .stdout(predicate::str::contains(
            "rollup_version: stwo-phase16-decoding-history-segment-rollup-v3",
        ))
    ...
    assert_eq!(
        proof_json
            .get("rollup_version")
            .and_then(serde_json::Value::as_str),
        Some("stwo-phase16-decoding-history-segment-rollup-v3")
    );
    assert_eq!(
        proof_json
            .get("total_rollups")
    ...
    verify
        ...
        .stdout(predicate::str::contains("verified_stark: true"))
        .stdout(predicate::str::contains(
            "expected_rollup_version: stwo-phase16-decoding-history-segment-rollup-v3",
        ))
        .stdout(predicate::str::contains(
            "expected_proof_backend_version: stwo-phase12-decoding-family-v1",
        ))
...
fn cli_can_prove_and_verify_stwo_decoding_history_rollup_matrix_demo() {
    ...
    prove
        ...
        .stdout(predicate::str::contains("proof_backend: stwo"))
        .stdout(predicate::str::contains(
            "matrix_version: stwo-phase17-decoding-history-rollup-matrix-v3",
        ))
        .stdout(predicate::str::contains("total_layouts: 3"));
    ...
    assert_eq!(
        proof_json
            .get("matrix_version")
            .and_then(serde_json::Value::as_str),
        Some("stwo-phase17-decoding-history-rollup-matrix-v3")
    );
    ...
    verify
        ...
        .stdout(predicate::str::contains("verified_stark: true"))
        .stdout(predicate::str::contains(
            "expected_matrix_version: stwo-phase17-decoding-history-rollup-matrix-v3",
        ))
        .stdout(predicate::str::contains(
            "expected_proof_backend_version: stwo-phase12-decoding-family-v1",
        ));
