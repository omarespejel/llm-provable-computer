...
/// Ported from stark-anatomy/code/rescue_prime.py.
...
impl RescuePrime {
    pub fn new() -> Self {
        ...
        RescuePrime {
            ...
            mds_inv: [
                [fe(210387253332845851216830350818816760948), fe(60110643809384528919094385948233360270)],
                [fe(90165965714076793378641578922350040407), fe(180331931428153586757283157844700080811)],
            ],
            round_constants: vec![
