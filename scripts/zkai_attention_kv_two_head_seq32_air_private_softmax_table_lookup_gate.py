#!/usr/bin/env python3
"""Checked AIR-constrained two-head seq32 Softmax-table lookup sidecar gate for issue #537.

This gate records the narrow positive result: the existing native two-head seq32 d=8
...
LOOKUP_ENVELOPE_JSON = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-two-head-seq32-softmax-table-logup-sidecar-proof-2026-05.envelope.json"
SOURCE_INPUT_SCRIPT = ROOT / "scripts" / "zkai_attention_kv_stwo_native_two_head_seq32_bounded_softmax_table_proof_input.py"
JSON_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-two-head-seq32-softmax-table-logup-sidecar-gate-2026-05.json"
TSV_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-two-head-seq32-softmax-table-logup-sidecar-gate-2026-05.tsv"

MAX_SOURCE_INPUT_JSON_BYTES = 4_194_304
MAX_LOOKUP_ENVELOPE_JSON_BYTES = 8_388_608

SCHEMA = "zkai-attention-kv-stwo-native-two-head-seq32-softmax-table-logup-sidecar-gate-v1"
ISSUE = 537
SOURCE_ISSUE = 537
DECISION = "GO_NATIVE_STWO_AIR_CONSTRAINED_TWO_HEAD_SEQ32_SOFTMAX_TABLE_LOOKUP_RELATION_SIDECAR"
CLAIM_BOUNDARY = (
    "NATIVE_STWO_TWO_HEAD_SEQ32_D8_BOUNDED_SOFTMAX_TABLE_LOOKUP_MEMBERSHIP_CONSTRAINED_BY_LOGUP_SIDECAR_"
...
SOURCE_DECISION = "GO_INPUT_FOR_STWO_NATIVE_ATTENTION_KV_TWO_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_AIR_PROOF"
...
LOOKUP_PROOF_VERSION = "stwo-attention-kv-two-head-seq32-softmax-table-logup-sidecar-proof-v1"
LOOKUP_STATEMENT_VERSION = "zkai-attention-kv-stwo-native-two-head-seq32-softmax-table-logup-sidecar-statement-v1"
LOOKUP_SEMANTIC_SCOPE = "two_head_seq32_bounded_softmax_table_membership_constrained_by_native_stwo_logup_sidecar"
LOOKUP_VERIFIER_DOMAIN = "ptvm:zkai:attention-kv-stwo-native-two-head-seq32-softmax-table-logup-sidecar:v1"
LOOKUP_TARGET_ID = "attention-kv-two-head-seq32-d8-causal-mask-bounded-softmax-table-logup-sidecar-v1"
LOOKUP_RELATION = "AttentionKvTwoHeadSeq32SoftmaxTableLookupRelation"
LOOKUP_RELATION_WIDTH = 2
LOOKUP_PROOF_SIZE_BYTES = 35_029
LOOKUP_ENVELOPE_SIZE_BYTES = 2_196_691
...
FIXED_TWO_HEAD_LOOKUP_CLAIMS = 336
FIXED_TWO_HEAD_LOOKUP_PROOF_SIZE_BYTES = 27_078
FIXED_TWO_HEAD_LOOKUP_ENVELOPE_SIZE_BYTES = 781_775
CLAIM_COUNT_RATIO = "3.523810"
PROOF_SIZE_RATIO = "1.293621"
ENVELOPE_SIZE_RATIO = "2.810382"
...
VALIDATION_COMMANDS = (
    ...
    "cargo +nightly-2025-07-14 run --locked --features stwo-backend --bin zkai_attention_kv_native_two_head_seq32_softmax_table_lookup_proof -- prove docs/engineering/evidence/zkai-attention-kv-stwo-native-two-head-seq32-bounded-softmax-table-proof-2026-05.json docs/engineering/evidence/zkai-attention-kv-stwo-native-two-head-seq32-softmax-table-logup-sidecar-proof-2026-05.envelope.json",
    ...
    "python3 -m unittest scripts.tests.test_zkai_attention_kv_two_head_seq32_air_private_softmax_table_lookup_gate",
    "just gate-fast",
    "just gate",
)
...
def verify_lookup_envelope_bytes_with_native_cli(envelope_bytes: bytes, label: str) -> None:
    ...
    command = [
        ...
        "stwo-backend",
        "--bin",
        "zkai_attention_kv_native_two_head_seq32_softmax_table_lookup_proof",
        "--",
        "verify",
        str(tmp_path),
    ]
...
def build_payload() -> dict[str, Any]:
    ...
    payload["gate_commitment"] = blake2b_commitment(
        ...
        "ptvm:zkai:attention-kv-two-head-seq32-softmax-table-logup-sidecar-gate:v1",
    )
...
def validate_payload(payload: Any, *, allow_missing_mutation_summary: bool = False) -> None:
    ...
    if any(not isinstance(case, dict) for case in cases):
        raise AttentionKvAirPrivateSoftmaxTableLookupGateError("mutation case must be an object")
