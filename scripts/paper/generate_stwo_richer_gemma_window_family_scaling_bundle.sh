...
BUNDLE_DIR="${BUNDLE_DIR:-$REPO_ROOT/docs/paper/artifacts/stwo-richer-gemma-window-family-scaling-v1-2026-04-22}"
...
SHARED_PROOF="$SOURCE_BUNDLE/gemma-block-v4.stark.json"

PHASE112_W4="$BUNDLE_DIR/phase112-transformer-accumulation-semantics-w4.stwo.json"
PHASE113_W4="$BUNDLE_DIR/phase113-richer-gemma-window-family-w4.stwo.json"
PHASE112_W8="$BUNDLE_DIR/phase112-transformer-accumulation-semantics-w8.stwo.json"
PHASE113_W8="$BUNDLE_DIR/phase113-richer-gemma-window-family-w8.stwo.json"
...
artifact_bundle: stwo-richer-gemma-window-family-scaling-v1-2026-04-22
...
cat > "$README_MD" <<EOF2
# Richer Gemma Window Family Scaling Bundle
