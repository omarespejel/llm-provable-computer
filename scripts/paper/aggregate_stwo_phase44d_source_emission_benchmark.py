...
# (`emit_ms`, `verify_ms`) with no additive identity, no hashing, and
# hard-pinned `EXPECTED_INPUT_TIMING_MODE` and
# `EXPECTED_INPUT_TIMING_POLICY`. All three bug classes fixed by
