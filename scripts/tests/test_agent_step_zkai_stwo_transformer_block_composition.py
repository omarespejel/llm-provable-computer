...
COMPOSITION_PATH = ROOT / "scripts" / "agent_step_zkai_stwo_transformer_block_composition.py"
SPEC = importlib.util.spec_from_file_location("agent_step_zkai_stwo_transformer_block_composition", COMPOSITION_PATH)
...
class AgentStepZkAIStwoTransformerBlockCompositionTests(unittest.TestCase):
    ...
    def test_rust_zkai_callback_verifier_rejects_tampered_subreceipt(self) -> None:
        with tempfile.TemporaryDirectory() as raw_tmp:
            ...
            tampered["model_id"] = "urn:zkai:ptvm:different-transformer-block"
