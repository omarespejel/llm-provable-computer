...
class AttentionKvProofRouteSelectorGateTests(unittest.TestCase):
    ...
    def test_regression_issue_448_records_native_stwo_and_external_control_routes(self) -> None:
        ...
        self.assertEqual(payload["multihead_quantized_softmax_receipt"]["fused_proof_size_bytes_sum"], 162351)
        self.assertEqual(payload["multihead_quantized_softmax_receipt"]["max_fused_proof_size_bytes"], 59375)
