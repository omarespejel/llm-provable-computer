...
from scripts import zkai_attention_kv_stwo_native_d16_bounded_softmax_table_proof_input as gate
...
class AttentionKvBoundedSoftmaxTableInputTests(unittest.TestCase):
    ...
    def test_rejects_source_journal_identity_drift(self):
        with mock.patch.object(gate.SOURCE, "KEY_WIDTH", 15):
            with self.assertRaisesRegex(gate.AttentionKvBoundedSoftmaxTableInputError, "source KEY_WIDTH drift"):
                gate.build_payload()
