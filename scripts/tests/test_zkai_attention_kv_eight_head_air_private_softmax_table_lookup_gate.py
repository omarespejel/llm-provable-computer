...
from scripts import zkai_attention_kv_eight_head_air_private_softmax_table_lookup_gate as gate
...
class AttentionKvAirPrivateSoftmaxTableLookupGateTests(unittest.TestCase):
    ...
    def test_build_payload_records_logup_sidecar_go(self):
        ...
        self.assertEqual(payload["single_head_comparison"]["four_head_lookup_claims"], 208)
        self.assertEqual(payload["single_head_comparison"]["single_to_eight_proof_size_ratio"], "1.471278")
        self.assertEqual(payload["single_head_comparison"]["four_to_eight_proof_size_ratio"], "0.995914")
    ...
    def test_tsv_summary_matches_payload(self):
        ...
        self.assertIn("1.471278", tsv)
        self.assertIn("0.995914", tsv)
