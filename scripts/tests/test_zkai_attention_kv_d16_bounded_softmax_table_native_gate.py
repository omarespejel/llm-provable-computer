...
from scripts import zkai_attention_kv_d16_bounded_softmax_table_native_gate as gate
...
class AttentionKvBoundedSoftmaxTableNativeGateTests(unittest.TestCase):
    ...
    def test_build_payload_records_weighted_go(self):
        ...
        self.assertEqual(receipt["proof_size_bytes"], 61516)
        self.assertEqual(receipt["envelope_size_bytes"], 639928)
        self.assertEqual(
