...
AGGREGATOR = ROOT / "scripts" / "engineering" / "aggregate_phase44d_carry_aware_experimental_scaling.py"
...
class Phase44DCarryAwareExperimentalScalingAggregatorTests(unittest.TestCase):
