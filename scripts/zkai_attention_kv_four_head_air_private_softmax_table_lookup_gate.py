#!/usr/bin/env python3
"""Checked AIR-constrained four-head Softmax-table lookup sidecar gate for issue #482.

This gate records the narrow positive result: the existing native four-head d=8
...
LOOKUP_ENVELOPE_JSON = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-four-head-softmax-table-logup-sidecar-proof-2026-05.envelope.json"
SOURCE_INPUT_SCRIPT = ROOT / "scripts" / "zkai_attention_kv_stwo_native_four_head_bounded_softmax_table_proof_input.py"
JSON_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-four-head-softmax-table-logup-sidecar-gate-2026-05.json"
TSV_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-four-head-softmax-table-logup-sidecar-gate-2026-05.tsv"

MAX_SOURCE_INPUT_JSON_BYTES = 1_048_576
MAX_LOOKUP_ENVELOPE_JSON_BYTES = 1_048_576

SCHEMA = "zkai-attention-kv-stwo-native-four-head-softmax-table-logup-sidecar-gate-v1"
ISSUE = 482
SOURCE_ISSUE = 482
DECISION = "GO_NATIVE_STWO_AIR_CONSTRAINED_FOUR_HEAD_SOFTMAX_TABLE_LOOKUP_RELATION_SIDECAR"
CLAIM_BOUNDARY = (
    "NATIVE_STWO_FOUR_HEAD_D8_BOUNDED_SOFTMAX_TABLE_LOOKUP_MEMBERSHIP_CONSTRAINED_BY_LOGUP_SIDECAR_"
...
NEXT_BACKEND_STEP = (
    ...
    "the sidecar now reproduces across single-head, two-head, and four-head source families"
)
...
LOOKUP_PROOF_VERSION = "stwo-attention-kv-four-head-softmax-table-logup-sidecar-proof-v1"
LOOKUP_STATEMENT_VERSION = "zkai-attention-kv-stwo-native-four-head-softmax-table-logup-sidecar-statement-v1"
LOOKUP_SEMANTIC_SCOPE = "four_head_bounded_softmax_table_membership_constrained_by_native_stwo_logup_sidecar"
LOOKUP_VERIFIER_DOMAIN = "ptvm:zkai:attention-kv-stwo-native-four-head-softmax-table-logup-sidecar:v1"
LOOKUP_TARGET_ID = "attention-kv-four-head-d8-causal-mask-bounded-softmax-table-logup-sidecar-v1"
LOOKUP_RELATION = "AttentionKvFourHeadSoftmaxTableLookupRelation"
LOOKUP_RELATION_WIDTH = 2
LOOKUP_PROOF_SIZE_BYTES = 21_783
LOOKUP_ENVELOPE_SIZE_BYTES = 543_187
...
CLAIM_COUNT_RATIO = "4.000000"
PROOF_SIZE_RATIO = "1.477314"
ENVELOPE_SIZE_RATIO = "2.537249"
TWO_TO_FOUR_CLAIM_COUNT_RATIO = "2.000000"
TWO_TO_FOUR_PROOF_SIZE_RATIO = "1.203215"
TWO_TO_FOUR_ENVELOPE_SIZE_RATIO = "1.628371"
...
VALIDATION_COMMANDS = (
    "cargo +nightly-2025-07-14 test attention_kv_four_head_softmax_table_lookup --lib --features stwo-backend",
    "cargo +nightly-2025-07-14 run --features stwo-backend --bin zkai_attention_kv_native_four_head_softmax_table_lookup_proof -- prove docs/engineering/evidence/zkai-attention-kv-stwo-native-four-head-bounded-softmax-table-proof-2026-05.json docs/engineering/evidence/zkai-attention-kv-stwo-native-four-head-softmax-table-logup-sidecar-proof-2026-05.envelope.json",
    "cargo +nightly-2025-07-14 run --features stwo-backend --bin zkai_attention_kv_native_four_head_softmax_table_lookup_proof -- verify docs/engineering/evidence/zkai-attention-kv-stwo-native-four-head-softmax-table-logup-sidecar-proof-2026-05.envelope.json",
    "python3 scripts/zkai_attention_kv_four_head_air_private_softmax_table_lookup_gate.py --write-json docs/engineering/evidence/zkai-attention-kv-stwo-native-four-head-softmax-table-logup-sidecar-gate-2026-05.json --write-tsv docs/engineering/evidence/zkai-attention-kv-stwo-native-four-head-softmax-table-logup-sidecar-gate-2026-05.tsv",
    "python3 -m unittest scripts.tests.test_zkai_attention_kv_four_head_air_private_softmax_table_lookup_gate",
    "just gate-fast",
    "just gate",
)
...
def verify_lookup_envelope_bytes_with_native_cli(envelope_bytes: bytes, label: str) -> None:
    ...
    command = [
        ...
        "stwo-backend",
        "--bin",
        "zkai_attention_kv_native_four_head_softmax_table_lookup_proof",
        "--",
        "verify",
        str(tmp_path),
    ]
...
def single_head_comparison() -> dict[str, Any]:
    return {
        ...
        "four_head_lookup_claims": SOURCE_SCORE_ROWS,
        "four_head_lookup_proof_size_bytes": LOOKUP_PROOF_SIZE_BYTES,
        "four_head_lookup_envelope_size_bytes": LOOKUP_ENVELOPE_SIZE_BYTES,
        "claim_count_ratio": CLAIM_COUNT_RATIO,
        "proof_size_ratio": PROOF_SIZE_RATIO,
        "envelope_size_ratio": ENVELOPE_SIZE_RATIO,
        "two_to_four_claim_count_ratio": TWO_TO_FOUR_CLAIM_COUNT_RATIO,
        "two_to_four_proof_size_ratio": TWO_TO_FOUR_PROOF_SIZE_RATIO,
        "two_to_four_envelope_size_ratio": TWO_TO_FOUR_ENVELOPE_SIZE_RATIO,
    }
...
def build_payload() -> dict[str, Any]:
    ...
    payload["gate_commitment"] = blake2b_commitment(
        ...
        "ptvm:zkai:attention-kv-four-head-softmax-table-logup-sidecar-gate:v1",
    )
...
def to_tsv(payload: dict[str, Any]) -> str:
    ...
    row = {
        ...
        "two_to_four_claim_count_ratio": comparison["two_to_four_claim_count_ratio"],
        "lookup_proof_size_bytes": receipt["lookup_proof_size_bytes"],
        ...
        "two_to_four_proof_size_ratio": comparison["two_to_four_proof_size_ratio"],
        ...
        "two_to_four_envelope_size_ratio": comparison["two_to_four_envelope_size_ratio"],
        "source_statement_commitment": receipt["source_statement_commitment"],
        "source_weight_table_commitment": receipt["source_weight_table_commitment"],
