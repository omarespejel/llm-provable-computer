#!/usr/bin/env python3
"""Checked native Stwo d16 bounded Softmax-table-attention gate for issue #501.

The gate records a native d16 attention/KV proof whose score-derived weights come
...
INPUT_JSON = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d16-bounded-softmax-table-proof-2026-05.json"
ENVELOPE_JSON = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d16-bounded-softmax-table-proof-2026-05.envelope.json"
INPUT_SCRIPT = ROOT / "scripts" / "zkai_attention_kv_stwo_native_d16_bounded_softmax_table_proof_input.py"
JSON_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d16-bounded-softmax-table-gate-2026-05.json"
TSV_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d16-bounded-softmax-table-gate-2026-05.tsv"
MAX_INPUT_JSON_BYTES = 1_048_576
MAX_ENVELOPE_JSON_BYTES = 2_097_152

NATIVE_INPUT_SCHEMA = "zkai-attention-kv-stwo-native-d16-bounded-softmax-table-air-proof-input-v1"
NATIVE_INPUT_DECISION = "GO_INPUT_FOR_STWO_NATIVE_ATTENTION_KV_D16_BOUNDED_SOFTMAX_TABLE_AIR_PROOF"
...
SCHEMA = "zkai-attention-kv-stwo-native-d16-bounded-softmax-table-gate-v1"
ISSUE = 501
SOURCE_ISSUE = 453
DECISION = "GO_NATIVE_STWO_ATTENTION_KV_BOUNDED_SOFTMAX_TABLE_D16_MASKED_SEQUENCE"
CLAIM_BOUNDARY = (
    "NATIVE_STWO_D16_CAUSAL_MASKED_BOUNDED_SOFTMAX_TABLE_ATTENTION_KV_PROOF_"
...
ROUTE_ID = "local_stwo_attention_kv_d16_bounded_softmax_table_masked_sequence_proof"

TARGET_ID = "attention-kv-d16-causal-mask-bounded-softmax-table-v1"
PROOF_VERSION = "stwo-attention-kv-d16-causal-mask-bounded-softmax-table-air-proof-v1"
REQUIRED_BACKEND_VERSION = "stwo-attention-kv-d16-causal-mask-bounded-softmax-table-v1"
STATEMENT_VERSION = "zkai-attention-kv-stwo-native-d16-bounded-softmax-table-statement-v1"
SEMANTIC_SCOPE = "d16_bounded_table_softmax_approx_attention_kv_causal_mask_rows_bound_to_statement_receipt"
...
PROOF_SIZE_BYTES = 61516
ENVELOPE_SIZE_BYTES = 639928
COMMITMENTS = {
    "statement_commitment": "blake2b-256:4292fdf43f7f08a5820584e3e80ba22e6bc8a378a9811a5983799b36badda462",
    "public_instance_commitment": "blake2b-256:bad2b16dd13bc731bace7459a4aee8c28f470de7541fa8181034552c22e1ca34",
    "score_row_commitment": "blake2b-256:7ad8c6066d1bf36cae62d4e2da29a9b3fd04b74acd6b1e4a33e6018464cbfb66",
    "final_kv_cache_commitment": "blake2b-256:f9ecd71ca201798438bf7382f6fcfda655b005d86c2137ef3c281501c44423b6",
    "outputs_commitment": "blake2b-256:671c804064c3c24265c8520508e95af23bf5f05884a0c35b4ee3f29ad3586c99",
    "weight_table_commitment": "blake2b-256:d2eb4b2f2162e4748a7eb125efb9cb499ca41698844f94eae039dfa96f45ceb5",
}
EXPECTED_ATTENTION_OUTPUTS = (
    [1, -4, 1, -5, 0, 4, -1, 3, -2, 2, -3, 1, -4, 1, -5, 0],
    [1, -4, 1, -5, -1, 3, -1, 3, -2, 1, -3, 1, -4, 1, -5, -1],
    [1, -3, -1, 1, -2, -1, -4, 3, 0, -3, 4, 1, -3, -1, 1, -2],
    [1, -4, 0, -4, -1, 3, -1, 3, -2, 1, -2, 1, -4, 0, -4, -1],
    [3, 1, 0, -2, -3, 3, 1, 0, -1, -3, -4, 3, 1, 0, -2, -3],
    [-1, -2, 1, -1, -4, 0, -2, 2, 0, -3, 2, -1, -2, 1, -1, -4],
    [0, -2, 0, -2, -1, 1, -1, 0, -1, -1, -2, 0, -2, 0, -2, -1],
    [0, -3, 2, -1, -4, 1, -2, 3, 0, -3, 2, 0, -3, 2, -1, -4],
)
...
INPUT_MODULE = load_script_module(INPUT_SCRIPT, "zkai_attention_kv_stwo_native_d16_bounded_softmax_table_proof_input")
...
def build_payload() -> dict[str, Any]:
    ...
    payload["gate_commitment"] = blake2b_commitment(
        ...
        "ptvm:zkai:attention-kv-d16-bounded-softmax-table-native-gate:v1",
    )
...
def mutate_payload(payload: dict[str, Any], name: str) -> dict[str, Any]:
    ...
    if name == "table_statement_commitment_relabeling":
        ...
        receipt["target_id"] = "attention-kv-d16-causal-mask-exact-softmax-v1"
