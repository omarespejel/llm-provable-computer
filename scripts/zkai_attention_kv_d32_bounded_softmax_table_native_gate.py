#!/usr/bin/env python3
"""Checked native Stwo d32 bounded Softmax-table-attention gate for issue #501.

The gate records a native d32 attention/KV proof whose score-derived weights come
...
INPUT_JSON = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d32-bounded-softmax-table-proof-2026-05.json"
ENVELOPE_JSON = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d32-bounded-softmax-table-proof-2026-05.envelope.json"
INPUT_SCRIPT = ROOT / "scripts" / "zkai_attention_kv_stwo_native_d32_bounded_softmax_table_proof_input.py"
JSON_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d32-bounded-softmax-table-gate-2026-05.json"
TSV_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d32-bounded-softmax-table-gate-2026-05.tsv"
MAX_INPUT_JSON_BYTES = 1_048_576
MAX_ENVELOPE_JSON_BYTES = 2_097_152

NATIVE_INPUT_SCHEMA = "zkai-attention-kv-stwo-native-d32-bounded-softmax-table-air-proof-input-v1"
NATIVE_INPUT_DECISION = "GO_INPUT_FOR_STWO_NATIVE_ATTENTION_KV_D32_BOUNDED_SOFTMAX_TABLE_AIR_PROOF"
...
SCHEMA = "zkai-attention-kv-stwo-native-d32-bounded-softmax-table-gate-v1"
ISSUE = 6
SOURCE_ISSUE = 501
DECISION = "GO_NATIVE_STWO_ATTENTION_KV_BOUNDED_SOFTMAX_TABLE_D32_MASKED_SEQUENCE"
CLAIM_BOUNDARY = (
    "NATIVE_STWO_D32_CAUSAL_MASKED_BOUNDED_SOFTMAX_TABLE_ATTENTION_KV_PROOF_"
...
ROUTE_ID = "local_stwo_attention_kv_d32_bounded_softmax_table_masked_sequence_proof"

TARGET_ID = "attention-kv-d32-causal-mask-bounded-softmax-table-v1"
PROOF_VERSION = "stwo-attention-kv-d32-causal-mask-bounded-softmax-table-air-proof-v1"
REQUIRED_BACKEND_VERSION = "stwo-attention-kv-d32-causal-mask-bounded-softmax-table-v1"
STATEMENT_VERSION = "zkai-attention-kv-stwo-native-d32-bounded-softmax-table-statement-v1"
SEMANTIC_SCOPE = "d32_bounded_table_softmax_approx_attention_kv_causal_mask_rows_bound_to_statement_receipt"
VERIFIER_DOMAIN = "ptvm:zkai:attention-kv-stwo-native-d32-bounded-softmax-table:v1"
...
PROOF_SIZE_BYTES = 101120
ENVELOPE_SIZE_BYTES = 1061990
COMMITMENTS = {
    "statement_commitment": "blake2b-256:4af09c5ac6c8450089a161e3bc16203a6ae7ecdf5a7e7db61f8adf5716c7dff2",
    "public_instance_commitment": "blake2b-256:b766261277d12de6ab09e8e57f45c9f411767f52ef9b873abec13bbd4f0e8b82",
    "score_row_commitment": "blake2b-256:41f6f2bc5241757627ec0a4f18dad27fe81a5a07070127bd7c131b9c4c54bf4d",
    "final_kv_cache_commitment": "blake2b-256:c6b0bed5675e1c7552f649df6fa4bc64f0a1dc7e20c5dd95e8be860fd9e6f9e6",
    "outputs_commitment": "blake2b-256:c2ab3242708287590947c71a8c18c5e4211f4953add88f7decbc5ba61663d03a",
    "weight_table_commitment": "blake2b-256:5d051b56bc57cec33985c25ff686379434c3419c3b52b7374840590f64ace458",
}
EXPECTED_ATTENTION_OUTPUTS = (
    [1, -4, 1, -5, 0, 4, -1, 3, -2, 2, -3, 1, -4, 1, -5, 0, 4, -1, 3, -2, 2, -3, 1, -4, 1, -5, 0, 4, -1, 3, -2, 2],
    [1, -4, 1, -5, -1, 3, -1, 3, -2, 1, -3, 1, -4, 1, -5, -1, 3, -1, 3, -2, 1, -3, 1, -4, 1, -5, -1, 3, -1, 3, -2, 1],
    [-1, -2, 1, 0, -3, -1, -2, 1, 1, -3, 3, -1, -2, 1, 0, -3, -1, -2, 1, 1, -3, 3, -1, -2, 1, 0, -3, -1, -2, 1, 1, -3],
    [1, -4, 0, -4, -1, 3, -1, 3, -2, 1, -2, 1, -4, 0, -4, -1, 3, -1, 3, -2, 1, -2, 1, -4, 0, -4, -1, 3, -1, 3, -2, 1],
    [3, 1, 0, -2, -3, 3, 1, 0, -1, -3, -4, 3, 1, 0, -2, -3, 3, 1, 0, -1, -3, -4, 3, 1, 0, -2, -3, 3, 1, 0, -1, -3],
    [-2, -3, -2, -2, -3, -2, -3, -2, -3, -3, -3, -2, -3, -2, -2, -3, -2, -3, -2, -3, -3, -3, -2, -3, -2, -2, -3, -2, -3, -2, -3, -3],
    [1, -3, 0, -4, -1, 3, -1, 2, -2, 0, -3, 1, -3, 0, -4, -1, 3, -1, 2, -2, 0, -3, 1, -3, 0, -4, -1, 3, -1, 2, -2, 0],
...
INPUT_MODULE = load_script_module(INPUT_SCRIPT, "zkai_attention_kv_stwo_native_d32_bounded_softmax_table_proof_input")
...
def build_payload() -> dict[str, Any]:
    ...
    payload["gate_commitment"] = blake2b_commitment(
        ...
        "ptvm:zkai:attention-kv-d32-bounded-softmax-table-native-gate:v1",
    )
...
def mutate_payload(payload: dict[str, Any], name: str) -> dict[str, Any]:
    ...
    if name == "table_statement_commitment_relabeling":
        ...
        receipt["target_id"] = "attention-kv-d32-causal-mask-exact-softmax-v1"
