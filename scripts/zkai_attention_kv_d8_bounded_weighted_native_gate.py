#!/usr/bin/env python3
"""Checked native Stwo d8 bounded weighted-attention gate for issue #460.

The gate records the first native d8 weighted attention/KV proof surface in this
...
INPUT_JSON = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d8-bounded-weighted-proof-2026-05.json"
ENVELOPE_JSON = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d8-bounded-weighted-proof-2026-05.envelope.json"
INPUT_SCRIPT = ROOT / "scripts" / "zkai_attention_kv_stwo_native_d8_bounded_weighted_proof_input.py"
JSON_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d8-bounded-weighted-gate-2026-05.json"
TSV_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d8-bounded-weighted-gate-2026-05.tsv"
MAX_INPUT_JSON_BYTES = 1_048_576
MAX_ENVELOPE_JSON_BYTES = 1_048_576

NATIVE_INPUT_SCHEMA = "zkai-attention-kv-stwo-native-d8-bounded-weighted-air-proof-input-v1"
NATIVE_INPUT_DECISION = "GO_INPUT_FOR_STWO_NATIVE_ATTENTION_KV_D8_BOUNDED_WEIGHTED_AIR_PROOF"
...
SCHEMA = "zkai-attention-kv-stwo-native-d8-bounded-weighted-gate-v1"
ISSUE = 460
SOURCE_ISSUE = 456
DECISION = "GO_NATIVE_STWO_ATTENTION_KV_BOUNDED_WEIGHTED_D8_MASKED_SEQUENCE"
CLAIM_BOUNDARY = (
    "NATIVE_STWO_D8_CAUSAL_MASKED_BOUNDED_WEIGHTED_ATTENTION_KV_PROOF_"
    "NOT_EXACT_SOFTMAX_NOT_LONG_CONTEXT_NOT_FULL_INFERENCE_NOT_RECURSION_OR_PCD"
)
FIRST_BLOCKER = "NO_EXACT_SOFTMAX_EXP_DIV_AIR_OR_TWO_HEAD_WEIGHTED_SYNTHESIS_YET"
ROUTE_ID = "local_stwo_attention_kv_d8_bounded_weighted_masked_sequence_proof"
...
COMMITMENTS = {
    ...
    "public_instance_commitment": "blake2b-256:c9a5cc96afc62629650f3041e043de5723ead8244136e069f5b80cc297765333",
    "score_row_commitment": "blake2b-256:e0bb80622c53d93004d92488f111b03a21ea13278f4d19658e34158beb0fc0bf",
    "final_kv_cache_commitment": "blake2b-256:5d1f356ee8eaa8c5e6bd040e99fecc10fa96f9e117d93d4e88f103d02066c02a",
    "outputs_commitment": "blake2b-256:5462bb712e33665feb3193d3a76cb0db8725a45e1742924bcfb5802d522f56d6",
}
...
INPUT_MODULE = load_script_module(INPUT_SCRIPT, "zkai_attention_kv_stwo_native_d8_bounded_weighted_proof_input")
...
def build_payload() -> dict[str, Any]:
    ...
    payload["gate_commitment"] = blake2b_commitment(
        ...
        "ptvm:zkai:attention-kv-d8-bounded-weighted-native-gate:v1",
    )
