#!/usr/bin/env python3
"""Build the native Stwo d=8 bounded weighted attention/KV proof input.

This answers issue #460 narrowly. It scales the issue #456 bounded weighted
attention/KV policy onto the existing d=8 causal-prefix masked sequence fixture:
...
ISSUE = 460
SOURCE_ISSUE = 456
TARGET_ID = "attention-kv-d8-causal-mask-bounded-weighted-v1"
REQUIRED_BACKEND_VERSION = "stwo-attention-kv-d8-causal-mask-bounded-weighted-v1"
PROOF_VERSION = "stwo-attention-kv-d8-causal-mask-bounded-weighted-air-proof-v1"
STATEMENT_VERSION = "zkai-attention-kv-stwo-native-d8-bounded-weighted-statement-v1"
SEMANTIC_SCOPE = "d8_bounded_power2_weighted_attention_kv_causal_mask_rows_bound_to_statement_receipt"
VERIFIER_DOMAIN = "ptvm:zkai:attention-kv-stwo-native-d8-bounded-weighted:v1"
...
ROW_DOMAIN = "ptvm:zkai:attention-kv-stwo-native-d8-bounded-weighted-score-rows:v1"
INITIAL_KV_DOMAIN = "ptvm:zkai:attention-kv-stwo-native-d8-bounded-weighted-initial-kv:v1"
INPUT_STEPS_DOMAIN = "ptvm:zkai:attention-kv-stwo-native-d8-bounded-weighted-input-steps:v1"
FINAL_KV_DOMAIN = "ptvm:zkai:attention-kv-stwo-native-d8-bounded-weighted-final-kv:v1"
OUTPUTS_DOMAIN = "ptvm:zkai:attention-kv-stwo-native-d8-bounded-weighted-outputs:v1"
PUBLIC_INSTANCE_DOMAIN = "ptvm:zkai:attention-kv-stwo-native-d8-bounded-weighted-public-instance:v1"
PROOF_NATIVE_PARAMETER_DOMAIN = "ptvm:zkai:attention-kv-stwo-native-d8-bounded-weighted-proof-parameters:v1"
...
def _load_source_module() -> Any:
    ...
    if spec is None or spec.loader is None:
        raise AttentionKvBoundedWeightedInputError(f"failed to load source script: {SOURCE_SCRIPT}")
