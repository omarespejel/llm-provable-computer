#!/usr/bin/env python3
"""Checked implementation-exact quantized Softmax-table receipt gate for issue #485.

This gate does not introduce a new real-valued Softmax claim. It wraps the
existing fused native Stwo D8 bounded Softmax-table proof and pins the exact
...
from scripts import zkai_attention_kv_d8_fused_softmax_table_native_gate as fused_gate  # noqa: E402

EVIDENCE_DIR = ROOT / "docs" / "engineering" / "evidence"
SOURCE_INPUT_JSON = fused_gate.SOURCE_INPUT_JSON
FUSED_ENVELOPE_JSON = fused_gate.FUSED_ENVELOPE_JSON
JSON_OUT = EVIDENCE_DIR / "zkai-attention-kv-quantized-softmax-receipt-gate-2026-05.json"
TSV_OUT = EVIDENCE_DIR / "zkai-attention-kv-quantized-softmax-receipt-gate-2026-05.tsv"

SCHEMA = "zkai-attention-kv-quantized-softmax-receipt-gate-v1"
ISSUE = 485
SOURCE_ISSUE = 478
SOURCE_ARITHMETIC_ISSUE = 463
DECISION = "GO_IMPLEMENTATION_EXACT_QUANTIZED_SOFTMAX_TABLE_RECEIPT"
ROUTE_ID = "local_stwo_attention_kv_d8_quantized_softmax_table_kernel_receipt"
CLAIM_BOUNDARY = (
    "ONE_NATIVE_STWO_FUSED_D8_ATTENTION_RECEIPT_FOR_A_FIXED_INTEGER_SOFTMAX_TABLE_KERNEL_"
...
SCORE_DOMAIN = "signed_i64_query_key_dot_products_over_d8_public_fixture_rows"
SCORE_SCALE = 1
