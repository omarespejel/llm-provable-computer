#!/usr/bin/env python3
"""Checked AIR-constrained eight-head Softmax-table lookup sidecar gate for issue #514.

This gate records the narrow positive result: the existing native eight-head d=8
...
LOOKUP_ENVELOPE_JSON = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-eight-head-softmax-table-logup-sidecar-proof-2026-05.envelope.json"
SOURCE_INPUT_SCRIPT = ROOT / "scripts" / "zkai_attention_kv_stwo_native_eight_head_bounded_softmax_table_proof_input.py"
JSON_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-eight-head-softmax-table-logup-sidecar-gate-2026-05.json"
TSV_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-eight-head-softmax-table-logup-sidecar-gate-2026-05.tsv"

MAX_SOURCE_INPUT_JSON_BYTES = 2_097_152
MAX_LOOKUP_ENVELOPE_JSON_BYTES = 2_097_152

SCHEMA = "zkai-attention-kv-stwo-native-eight-head-softmax-table-logup-sidecar-gate-v1"
ISSUE = 514
SOURCE_ISSUE = 496
DECISION = "GO_NATIVE_STWO_AIR_CONSTRAINED_EIGHT_HEAD_SOFTMAX_TABLE_LOOKUP_RELATION_SIDECAR"
CLAIM_BOUNDARY = (
    "NATIVE_STWO_EIGHT_HEAD_D8_BOUNDED_SOFTMAX_TABLE_LOOKUP_MEMBERSHIP_CONSTRAINED_BY_LOGUP_SIDECAR_"
...
NEXT_BACKEND_STEP = (
    "use this matched eight-head sidecar as the source-plus-sidecar comparator for the fused route matrix; "
    "the sidecar now reproduces across single-head, two-head, four-head, and eight-head source families"
)
...
LOOKUP_PROOF_VERSION = "stwo-attention-kv-eight-head-softmax-table-logup-sidecar-proof-v1"
LOOKUP_STATEMENT_VERSION = "zkai-attention-kv-stwo-native-eight-head-softmax-table-logup-sidecar-statement-v1"
LOOKUP_SEMANTIC_SCOPE = "eight_head_bounded_softmax_table_membership_constrained_by_native_stwo_logup_sidecar"
LOOKUP_VERIFIER_DOMAIN = "ptvm:zkai:attention-kv-stwo-native-eight-head-softmax-table-logup-sidecar:v1"
LOOKUP_TARGET_ID = "attention-kv-eight-head-d8-causal-mask-bounded-softmax-table-logup-sidecar-v1"
LOOKUP_RELATION = "AttentionKvEightHeadSoftmaxTableLookupRelation"
LOOKUP_RELATION_WIDTH = 2
LOOKUP_PROOF_SIZE_BYTES = 21_694
...
TSV_COLUMNS = (
    ...
    "single_to_eight_claim_count_ratio",
    "two_to_eight_claim_count_ratio",
    "four_to_eight_claim_count_ratio",
    ...
    "single_to_eight_proof_size_ratio",
    "two_to_eight_proof_size_ratio",
    "four_to_eight_proof_size_ratio",
    ...
    "single_to_eight_envelope_size_ratio",
    "two_to_eight_envelope_size_ratio",
...
def verify_lookup_envelope_bytes_with_native_cli(envelope_bytes: bytes, label: str) -> None:
    ...
    command = [
        ...
        "stwo-backend",
        "--bin",
        "zkai_attention_kv_native_eight_head_softmax_table_lookup_proof",
        "--",
        "verify",
        str(tmp_path),
    ]
...
def single_head_comparison() -> dict[str, Any]:
    return {
        ...
        "eight_head_lookup_claims": SOURCE_SCORE_ROWS,
        "eight_head_lookup_proof_size_bytes": LOOKUP_PROOF_SIZE_BYTES,
        "eight_head_lookup_envelope_size_bytes": LOOKUP_ENVELOPE_SIZE_BYTES,
        "single_to_eight_claim_count_ratio": SINGLE_TO_EIGHT_CLAIM_COUNT_RATIO,
        "single_to_eight_proof_size_ratio": SINGLE_TO_EIGHT_PROOF_SIZE_RATIO,
        "single_to_eight_envelope_size_ratio": SINGLE_TO_EIGHT_ENVELOPE_SIZE_RATIO,
        "two_to_eight_claim_count_ratio": TWO_TO_EIGHT_CLAIM_COUNT_RATIO,
        "two_to_eight_proof_size_ratio": TWO_TO_EIGHT_PROOF_SIZE_RATIO,
        "two_to_eight_envelope_size_ratio": TWO_TO_EIGHT_ENVELOPE_SIZE_RATIO,
        "four_to_eight_claim_count_ratio": FOUR_TO_EIGHT_CLAIM_COUNT_RATIO,
        "four_to_eight_proof_size_ratio": FOUR_TO_EIGHT_PROOF_SIZE_RATIO,
        "four_to_eight_envelope_size_ratio": FOUR_TO_EIGHT_ENVELOPE_SIZE_RATIO,
    }


def build_payload() -> dict[str, Any]:
    source_input = read_bounded_json(SOURCE_INPUT_JSON, MAX_SOURCE_INPUT_JSON_BYTES, "source eight-head bounded Softmax-table input")
    validate_source_input(source_input)
...
def to_tsv(payload: dict[str, Any]) -> str:
    ...
    row = {
        ...
        "single_to_eight_claim_count_ratio": comparison["single_to_eight_claim_count_ratio"],
        "two_to_eight_claim_count_ratio": comparison["two_to_eight_claim_count_ratio"],
        "four_to_eight_claim_count_ratio": comparison["four_to_eight_claim_count_ratio"],
        "lookup_proof_size_bytes": receipt["lookup_proof_size_bytes"],
        ...
        "single_to_eight_proof_size_ratio": comparison["single_to_eight_proof_size_ratio"],
        "two_to_eight_proof_size_ratio": comparison["two_to_eight_proof_size_ratio"],
        "four_to_eight_proof_size_ratio": comparison["four_to_eight_proof_size_ratio"],
        ...
        "single_to_eight_envelope_size_ratio": comparison["single_to_eight_envelope_size_ratio"],
        "two_to_eight_envelope_size_ratio": comparison["two_to_eight_envelope_size_ratio"],
