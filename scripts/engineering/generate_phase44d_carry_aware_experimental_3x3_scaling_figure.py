#!/usr/bin/env python3
"""Render a publication-style figure for the Phase44D carry-aware experimental 3x3 scaling sweep."""
...
EXPECTED_BENCHMARK_VERSION = "stwo-phase44d-source-emission-experimental-3x3-layout-benchmark-v1"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-prefix",
        type=Path,
        default=DEFAULT_OUTDIR / "phase44d-carry-aware-experimental-3x3-scaling-2026-04",
    )
...
def main() -> None:
    ...
    verify_ax.set_title("Carry-aware Phase44D verification scaling (3x3 layout)")
