...
pub use tensor_native_artifact::{
    ...
    verify_phase98_folded_gemma_richer_slice_family_artifact, Phase93TensorNativeChainArtifact,
    ...
    MAX_PHASE95_REPEATED_GEMMA_TOTAL_SLICES, PHASE965_DEFAULT_BOUNDED_FOLD_ARITY,
