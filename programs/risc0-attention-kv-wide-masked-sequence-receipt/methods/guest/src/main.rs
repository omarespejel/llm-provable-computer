...
fn main() {
    ...
    let journal = AttentionSequenceJournal {
        schema: "zkai-attention-kv-risc0-wide-masked-sequence-journal-v1".to_string(),
        semantics: "tiny-single-head-integer-argmax-attention-wide-masked-sequence-v1".to_string(),
