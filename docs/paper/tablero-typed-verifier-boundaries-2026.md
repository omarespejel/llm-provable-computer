...
Stwo-native primitive adapter (`stwo-phase10-linear-block-v4-with-lookup`,
`43` executed steps, generated by
`scripts/zkai_stwo_statement_envelope_benchmark.py`) rejects `14 / 14`. The
