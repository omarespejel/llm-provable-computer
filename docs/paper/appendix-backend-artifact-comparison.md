...
| `addition` | `stwo` | `stwo-experimental-v1` | `2s` (`commands.log` entry 1, `prove-stark programs/addition.tvm --backend stwo -o /Users/espejelomar/StarkNet/zk-ai/llm-provable-computer-codex/docs/paper/artifacts/stwo-experimental-v1-2026-04-06/addition.stwo.proof.json`; `APPENDIX_ARTIFACT_INDEX.md` row `prove_addition_stwo`) | `1s` (`commands.log` entry 2, `verify-stark addition.stwo.proof.json`; `APPENDIX_ARTIFACT_INDEX.md` row `verify_addition_stwo`) | `54,563` bytes (`APPENDIX_ARTIFACT_INDEX.md` row `addition.stwo.proof.json`) | arithmetic `statement-v1` execution proof (`APPENDIX_ARTIFACT_INDEX.md` row `addition.stwo.proof.json`) |
