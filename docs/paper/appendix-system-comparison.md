...
| Strongest public evidence | Official Lagrange product/blog materials | Public repo, verifier docs, audit notes, Starknet verification path | Two frozen artifact bundles plus statement-versioned repo outputs |
...
| Recursion posture | Present in system architecture, but details vary by release | Publicly aligned with S-two / STWO recursion path | Not implemented; repo currently stops at frozen narrow S-two execution proofs, proof-carrying decoding demos, and experimental pre-recursive accumulator seams |
