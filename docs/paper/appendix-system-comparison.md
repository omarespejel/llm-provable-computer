...
| Strongest public evidence | Official Lagrange product/blog materials                                                         | Public repo, verifier docs, audit notes, Starknet verification path                                                                                                                 | Checked evidence files for Figures 3, 4, and 4B-4F, carried-state and proof-carrying bundles under [`artifacts/`](artifacts/), and statement-versioned repo outputs         |
