...
| Native d128 block receipt | The six checked d128 slice handles now compose into one statement-bound block receipt over `197504` checked rows; the composition gate rejects `19 / 19` missing/reordered/duplicated/stale/relabeling/verifier-domain/source-hash mutations and binds the final output activation commitment `blake2b-256:869a0046bdaba3f6a7f98a3ffec618479c9dc91df2a342900c76f9ba53215fc1`; evidence: `docs/engineering/evidence/zkai-d128-block-receipt-composition-gate-2026-05.json`; reproduce: `python3 scripts/zkai_d128_block_receipt_composition_gate.py --write-json docs/engineering/evidence/zkai-d128-block-receipt-composition-gate-2026-05.json --write-tsv docs/engineering/evidence/zkai-d128-block-receipt-composition-gate-2026-05.tsv`. |
