...
| Recursive compression | No recursive verifier, no proof-carrying data theorem, and no incrementally verifiable computation construction. The new d64 feasibility gate is explicit evidence for the current boundary: the receipt is a valid aggregation target, not a recursive aggregate proof. |
