...
The artifact filenames retain legacy phase-numbered names for checksum stability and provenance. In publication-facing prose, the corresponding ladder is described as chain, segment, interval package, rollup, matrix, and aggregation package.
