...
- `linear-block-v4-with-lookup.stark.json`: shared execution proof surface reused across every repeated-window artifact in `stwo-repeated-window-fold-tree-v1-2026-04-22`.
