...
This bundle freezes the first compact transformer-specific accumulation-semantics artifact derived from the frozen repeated Linear-block-like Phase107 leaf family. It keeps the semantic handoff that later accumulation layers need while dropping the larger verifier-bound fold-tree surface.
