...
`EXTERNAL_SNARK_AND_RISC0_TRANSITION_SEQUENCE_SCALED_SEQUENCE_RECEIPTS_PROOF_BACKED_NOT_NATIVE_STWO_OR_SOFTMAX`
...
| RISC Zero scaled sequence verifier time | `21.833 ms` engineering-only single local run |
