...
- repeated Gemma-like windows can be reduced by a canonical fold operator,
...
- fixed repeated Gemma-like window shape,
...
- one compact accumulation-semantics artifact over repeated Gemma-like windows,
