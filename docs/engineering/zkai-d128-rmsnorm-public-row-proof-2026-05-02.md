...
- a projection, activation, down-projection, bridge, or residual proof;
...
The d128 route now has two real proof slices:
...
"can anything at d128 prove?" It is now the missing bridge/projection/activation
/down-projection/composition ladder.
